...
export function Navbar() {
  ...
  return <header className={`fixed inset-x-0 top-0 z-50 transition-all duration-500 ${scrolled ? 'border-b border-white/10 bg-apex-ink/80 backdrop-blur-xl' : ''}`}>
